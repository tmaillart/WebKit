...
static gboolean foooSuccessSource(gpointer userData)
{
...
static void foooSuccessExecutor(JSCValue* resolve, JSCValue* reject, gpointer userData)
{
    AsyncPromiseTestData* foo = static_cast<AsyncPromiseTestData*>(userData);
    foo->value = resolve;
}
...
static gboolean foooFailureSource(gpointer userData)
{
    AsyncPromiseTestData* foo = static_cast<AsyncPromiseTestData*>(userData);
    g_object_unref(jsc_value_function_call(foo->value.get(), G_TYPE_NONE));
    foo->value = nullptr;
...
static void foooFailureExecutor(JSCValue* resolve, JSCValue* reject, gpointer userData)
{
    AsyncPromiseTestData* foo = static_cast<AsyncPromiseTestData*>(userData);
    foo->value = reject;
}
...
static void testJSCPromises()
{
    ...
    {
        AsyncPromiseTestData foo = { .mainLoop = adoptGRef(g_main_loop_new(NULL, FALSE)), .value = nullptr };
        ...
        GRefPtr<JSCValue> resolve_func = adoptGRef(jsc_context_evaluate(context.get(), "res = function (a) { result = 1; }", -1));
        GRefPtr<JSCValue> reject_func  = adoptGRef(jsc_context_evaluate(context.get(), "rej = function (a) { result = 2; }", -1));
